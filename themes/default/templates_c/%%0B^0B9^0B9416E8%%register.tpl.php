<?php /* Smarty version 2.6.25, created on 2015-04-08 16:04:02
         compiled from admin/register.tpl */ ?>
<!DOCTYPE html>
<html>
  <head>
    <title>
    ...
    <link href="http://fonts.useso.com/css?family=Lato:100,300,400,700" media="all" rel="stylesheet" type="text/css" /><link href="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
...
/stylesheets/style.css" media="all" rel="stylesheet" type="text/css" /><script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
javascripts/jquery-1.10.2.min.js" type="text/javascript"></script><script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
/javascripts/jquery-ui.js" type="text/javascript"></script><script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
...
/javascripts/masonry.min.js" type="text/javascript"></script><script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
  ...
  <body class="login1 signup">
    ...
    <div class="login-wrapper">
      <div class="login-container">
        <a href="#"><img width="100" height="30" src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
/images/logo-login@2x.png" /></a>
        <form action="<?php echo $this->_tpl_vars['url']['root']; ?>
/register-test/submit" method="post">
          ...
          <div class="form-options">
                  ...
                  已经有账户了？ <a href="<?php echo $this->_tpl_vars['url']['root']; ?>
/login">立即登录</a>
              </p>
          </div>
        </form>
