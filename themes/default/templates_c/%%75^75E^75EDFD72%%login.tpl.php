<?php /* Smarty version 2.6.25, created on 2015-04-02 21:01:39
...
stylesheets/bootstrap.min.css" media="all" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
stylesheets/font-awesome.css" media="all" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
stylesheets/se7en-font.css" media="all" rel="stylesheet" type="text/css" />
    <link href="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
stylesheets/style.css" media="all" rel="stylesheet" type="text/css" />
...
javascripts/jquery-ui.js" type="text/javascript"></script>
	<script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
javascripts/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
javascripts/raphael.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
javascripts/jquery.mousewheel.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
javascripts/jquery.vmap.min.js" type="text/javascript"></script>
    <script src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
  ...
  <body class="login1">
    ...
    <div class="login-wrapper">
      <div class="login-container">
        <a href="login"><img width="100" height="30" src="<?php echo $this->_tpl_vars['url']['adminStyle']; ?>
images/logo-login%402x.png" /></a>
