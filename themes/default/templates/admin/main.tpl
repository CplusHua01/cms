      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a class="current" href="{$url.root}/admin/main"><span aria-hidden="true" class="se7en-home"></span>指示板</a>
              </li>
              <li><a href="{$url.root}/admin/usermanage" >
                <span aria-hidden="true" class="icon-group"></span>用户管理</a>
              </li>
                <li><a href="{$url.root}/admin/key">
                    <span aria-hidden="true" class="icon-rocket"></span>邀请码</a>
                </li>
                <li><a href="{$url.root}/admin/time">
                    <span aria-hidden="true" class="icon-bug"></span>时间轴管理</a>
                </li>
                <li><a href="{$url.root}/admin/filemanage">
